...
The final image is generated by FLUX.2 Pro through fal.ai. GPT/OpenAI is not
wired into the active prompt-refinement or image-generation pipeline; its
implementations remain only as legacy code.
