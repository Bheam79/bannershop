...
namespace BannerShop.Infrastructure.Data.Migrations
{
    ...
    public partial class AddStripeSettings : Migration
    {
        ...
        {
            migrationBuilder.DeleteData(table: "SystemSettings", keyColumn: "Id", keyValue: 4);
            migrationBuilder.DeleteData(table: "SystemSettings", keyColumn: "Id", keyValue: 5);
            migrationBuilder.DeleteData(table: "SystemSettings", keyColumn: "Id", keyValue: 6);
        }
    }
}
